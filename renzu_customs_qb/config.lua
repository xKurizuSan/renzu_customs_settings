...
Config.Customs = { -- Multiple Shop Start
	...
	['Crows'] = { -- Shop id -- Custom Map Tuner Garage (2372 Build only, canary and release) IPL and Int https://forum.cfx.re/t/free-mlo-tuner-auto-shop/4247145
		job = 'crows', -- job name permmision for this shop
		min_grade = 0, -- min grade to access the whole shop feature
		radius = 15, -- radius for whole shop
		stockroom = {coord = vector4(776.1, -1632.83, 31.18, 99.91), grade = 0},
		paintmenu = {coord = vector4(786.56, -1641.3, 31.18, 266.94), grade = 0},
		garage_inventory = {coord = vector4(775.31, -1637.11, 31.18, 88.19), grade = 0},
		shopcoord = vector4(779.84, -1640.5, 31.18, 341.24),
		mod = {
			{coord = vector4(781.1, -1641.23, 31.18, 348.0), taken = false},
			{coord = vector4(777.19, -1635.9, 31.18, 356.42), taken = false},
		},
		Blips = {sprite = 446, color = 68, scale = 0.7},
    },
}
